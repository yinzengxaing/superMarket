...
public class AddSupplierFrame {
	...
	public class AddButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			 ...
			 if (name.equals("") || address.equals("") || provide.equals("") ||  linkman.equals("") || linkPhone.equals("")){
				 JOptionPane.showMessageDialog(null, "请将供货商信息补充完整！", "提示", JOptionPane.ERROR_MESSAGE);
				 return ;
			 }
			 
			 
			 Supplier supplier = new Supplier(null, name, address, provide, linkman, linkPhone, faxes, postNum, bankNum, netAddress, emailAddress, remark);
			 dao.addSuppliser(supplier);

...
public class UpdateGoodsFrame {
	...
	public UpdateGoodsFrame(Goods goods) {
		this.goods = goods;
		initialize();
	}
	...
	private void initialize() {
		...
		//为输入框付初值
		t_goodsName.setText(goods.getGoodsName());
		t_goodsBewrite.setText(goods.getGoodsBewrite());
		t_units.setText(goods.getUnits());
		t_stockPrice.setText(""+goods.getStockPrice());
		t_associatorPrice.setText(""+goods.getAssociatorPrice());
		t_retailPrice.setText(""+goods.getRetailPrice());
	...
	public class AddButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			String id = goods.getId();
			 ...
			 Goods goods = new Goods(id, goodsName, goodsBewrite, units, stockPrice, retailPrice, associatorPrice);

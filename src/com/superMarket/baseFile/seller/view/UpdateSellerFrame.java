...
public class UpdateSellerFrame {
	public  JFrame frame;
	...
	public UpdateSellerFrame(Seller seller ) {
		this.seller = seller;
		initialize();
	}
	...
	private void initialize() {
		...
		//对修改页面进行数据填充
		t_name.setText(seller.getName());
		t_address.setText(seller.getAddress());
		t_linkman.setText(seller.getAddress());
		t_linkPhone.setText(seller.getLinkPhone());
		t_faxes.setText(seller.getFaxes());
		t_postNum.setText(seller.getPostNum());
		t_netAddress.setText(seller.getNetAddress());
		t_emailAddress.setText(seller.getEmailAddress());
		t_remark.setText(seller.getRemark());
	}
	...
	public class AddButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			// String provide = t_provide.getText();
			 ...
			 Seller seller = new Seller(id, name, address, linkman, linkPhone, faxes, postNum, bankNum, netAddress, emailAddress, remark);

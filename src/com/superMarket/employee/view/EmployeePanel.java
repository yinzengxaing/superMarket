	...
	public class DeleteButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			int isdel = JOptionPane.showConfirmDialog(null,
				       "是否确定删除该职工信息？", "删除职工信息？", JOptionPane.YES_NO_OPTION,
	...
	public class SearchButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (SelectItem== null || SelectItem.equals("请选择...")){
				...
				textField_1.setText("");
				return;
			}else if (SelectItem.equals("姓名")){
				 list = employeeDao.selectByName(SelectStr);
				 if (list.isEmpty()){
				 ...
				 model.setData(list);
			}else if (SelectItem.equals("职位")){
				 list = employeeDao.selectByDuty(SelectStr);
				 if (list.isEmpty()){
						JOptionPane.showMessageDialog(null, "未查询到该关键字,请重试！", "警告", JOptionPane.ERROR_MESSAGE);
						textField_1.setText("");
					return;	
				 	...
				 	model.setData(list);
			}else if (SelectItem.equals("部门")){
				 list = employeeDao.selectByDepartment(SelectStr);
				 if (list.isEmpty()){
						JOptionPane.showMessageDialog(null, "未查询到该关键字,请重试！", "警告", JOptionPane.ERROR_MESSAGE);
						textField_1.setText("");
					return;	
	...
	public class UpdateButtonListener implements  ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			id = (String) table.getValueAt(row, 0);
				 ...
				 JOptionPane.showMessageDialog(null, "请选取需要修改的员工！", "警告", JOptionPane.ERROR_MESSAGE);
				return;
			}
			textField_1.setText("");
			Employee employeeById = employeeDao.getEmployeeById(id);
			new updateEmployeeFrame(employeeById);

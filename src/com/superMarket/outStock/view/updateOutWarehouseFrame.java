...
public class updateOutWarehouseFrame {
	...
	public updateOutWarehouseFrame(OutWarehouse outWarehouse) {
	...
	private void initialize() {
		...
		// 填充数据
		orderIdBox.setSelectedItem(outWarehouse.getOrderId());
		wearhouseIdBox.setSelectedItem(outWarehouse.getWarehouseId());
		goodsName_t.setText(outWarehouse.getGoodsName());
		outDate_btn.setText(outWarehouse.getOutDate());
		weight_t.setText(outWarehouse.getWeight() + "");
		remark_t.setText(outWarehouse.getRemark());
	...
	public class addBtnListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			OutWarehouse newoutWarehouse = new OutWarehouse(outWarehouse.getId(), orderId, warehouseId, goodsName,
					outDate, weight, remark);
			outWarehouseDao.updateOutWarehouse(newoutWarehouse);

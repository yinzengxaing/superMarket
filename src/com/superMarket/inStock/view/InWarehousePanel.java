...
public class InWarehousePanel {
	private JPanel myPanel;// 主界面
	private JTextField textField; // 订单号输入框
	private JTextField textField_1; // 入库时间输入框
	public static JTable table;
	private JPanel TablePanel;
	private InWarehouseTableModel model;
	private InWarehouseDao dao = new InWarehouseDaoImpl();
	...
	public JPanel getPanel() {
		...
		model = new InWarehouseTableModel();
		table = new JTable(model);
		scrollPane.setViewportView(table);
		scrollPane.setBorder(BorderFactory.createTitledBorder("入库列表"));
		return myPanel;
	...
	public class DeleteButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (isdel == 1)
				return;
			textField.setText("");
			dao.delInWarehouse(id);
			 table.removeAll();
			table.setModel(new InWarehouseTableModel());
		}
	...
	public class SearchButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			List<InWarehouse> list = null;
			list = dao.selectInwarehouseList(derId, inDate);
				if (list.isEmpty()){
	...
	public class UpdateButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			String id;
			 ...
			 InWarehouse inWarehouseById = dao.getInWarehouseById(id);
			 textField.setText("");
			 new updateInWarehouseFrame(inWarehouseById);
			  table.setModel(new InWarehouseTableModel());
//			 
		}

...
public class updateInWarehouseFrame {
	...
	public updateInWarehouseFrame(InWarehouse inWarehouse) {
	...
	private void initialize() {
		...
		//填充数据
		orderIdBox.setSelectedItem(inWarehouse.getOrderId());
		wearhouseIdBox.setSelectedItem(inWarehouse.getWarehouseId());
		goodsName_t.setText(inWarehouse.getGoodsName());
		inDate_btn.setText(inWarehouse.getInDate());
		weight_t.setText(inWarehouse.getWeight()+"");
		remark_t.setText(inWarehouse.getRemark());
...
public class addBtnListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		double weight = 0.0;
			...
			InWarehouse newinWarehouse = new InWarehouse(inWarehouse.getId(), orderId, warehouseId, goodsName, inDate, weight, remark);
			inWarehouseDao.updateInWarehouse(newinWarehouse);
